//Using Mikhail Timofeev code from classes
...
router.post('/post/json', function (req, res) {
        ...
        function appendJSON(obj) {
            ...
            XMLtoJSON('2020005CarSales.xml', function (err, result) {
                if (err) throw (err);
                
                result.root.section[obj.sec_n].entry.push({'item': obj.item, 'price': obj.price});
    
                console.log(JSON.stringify(result, null, "  "));
    
                JSONtoXML('2020005CarSales.xml', result, function(err){
    ...
    router.post('/post/delete', function (req, res) {
        ...
        function deleteJSON(obj) {
            ...
            XMLtoJSON('2020005CarSales.xml', function (err, result) {
                ...
                delete result.root.section[obj.section].entry[obj.entree];
